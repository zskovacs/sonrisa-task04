...
| Q-18 | Email | One configured sender/profile. Provider, mechanism, sender setup, authorized live-test recipients, and error mapping remain open. User destinations are stored in PostgreSQL. | Authorized email setup and tests. |
